...
const SingleToyDetailsCard = () => {
  ...
  return (
    <div className="hero min-h-screen mt-4 mb-16" style={{minHeight: `calc(100vh - 24em)`}}>
      <div className="card grid grid-cols-1 md:grid-cols-3 shadow-xl">
        <figure className="col-span-1">
          <img className="h-64 md:h-72 lg:h-80 xl:h-96 rounded-2xl" src={picture} alt="Album" />
        </figure>
        ...
        <div className="card-body col-span-2">
          ...
          <p>Available Quantity: <b>{availableQuantity}</b></p>
          <p>Detail Description: <span className="ps-8 block"><b>{description}</b></span></p>
        </div>
      </div>
    </div>
  );
