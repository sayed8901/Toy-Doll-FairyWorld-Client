    ...
    return (
      <div className="mt-16 mb-32">
        ...
        <Marquee speed={150} pauseOnHover={true} loop={0} className="overflow-y-hidden">
          <LazyLoad>
            <img
              className="h-48 lg:h-64 xl:h-72 rounded-2xl group hover:scale-125 duration-300"
          ...
          {/* <LazyLoad>
            <img
              className="h-48 lg:h-64 xl:h-72 rounded-2xl mr-24 group hover:scale-125 duration-300"
          ...
          <LazyLoad>
            <img
              className="h-48 lg:h-64 xl:h-72 rounded-2xl mx-12 group hover:scale-125 duration-300"
          ...
          {/* <LazyLoad>
            <img
              className="h-48 lg:h-64 xl:h-72 rounded-2xl mr-12 group hover:scale-125 duration-300"
